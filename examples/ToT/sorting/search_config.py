...
from examples.sort.dataset import SortExample


from reasoners import SearchConfig, LanguageModel
from world_model_sort import SortState, SortAction, SortWorldModel
...
class SortConfig(SearchConfig[SortState, SortAction, SortExample]):
    ...
    def __init__(self, base_model: LanguageModel, temperature=0.8, n_candidates=4):
        ...
        self.example: SortExample = self.example
